                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('country.destroy',$item->id) }}" method="POST">
                                                <a class="btn btn-info" href="{{ route('country.show',$item->id) }}"><i class="bi bi-eye"></i></a>
                                                <a class="btn btn-primary" href="{{ route('country.edit',$item->id) }}"><i class="bi bi-pencil"></i></a>
