...
<body id="body">
	...
	<!-- Bootstrap Touchpin -->
	<script src="{{asset('front/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js')}}"></script>
	<!-- Instagram Feed Js -->
	<script src="{{asset('front/plugins/instafeed/instafeed.min.js')}}"></script>
	<!-- Video Lightbox Plugin -->
	<script src="{{asset('front/plugins/ekko-lightbox/dist/ekko-lightbox.min.js')}}"></script>
	<!-- Count Down Js -->
	<script src="{{asset('front/plugins/syo-timer/build/jquery.syotimer.min.js')}}"></script>
	...
	<script type="text/javascript" src="{{asset('front/plugins/google-map/gmap.js')}}"></script>
